...
public:
	...
	ASCENT_INLINE void AddPlayer(PlayerPointer pPlayer) { mPassengers[pPlayer->GetLowGUID()] = pPlayer; }
	ASCENT_INLINE void RemovePlayer(PlayerPointer pPlayer) {mPassengers.erase(pPlayer->GetLowGUID()); }
	ASCENT_INLINE bool HasPlayer(PlayerPointer pPlayer) { return mPassengers.find(pPlayer->GetLowGUID()) != mPassengers.end(); }
