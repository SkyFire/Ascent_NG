...
{    
	...
	ITEM_FIELD_STACK_COUNT                    = OBJECT_END + 0x0008, // Size: 1, Type: INT, Flags: OWNER, 
	ITEM_FIELD_DURATION						  = OBJECT_END + 0x0009, // Size: 1, Type: INT, Flags: OWNER, 
	ITEM_FIELD_SPELL_CHARGES				  = OBJECT_END + 0x000A, // Size: 5, Type: INT, Flags: OWNER, 
	...
	ITEM_FIELD_DURABILITY                     = OBJECT_END + 0x0037, // Size: 1, Type: INT, Flags: OWNER, 
	ITEM_FIELD_MAXDURABILITY				  = OBJECT_END + 0x0038, // Size: 1, Type: INT, Flags: OWNER, 
