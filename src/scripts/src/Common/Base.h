...
#define ASCENTSCRIPT_FACTORY_FUNCTION(ClassName, ParentClassName)\
public:\
...
typedef void(*SpellFunc)(SpellDesc* pThis, AscentScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Class AscentScriptCreatureAI
class AscentScriptCreatureAI : public CreatureAIScript
{
public:
	AscentScriptCreatureAI(Creature* pCreature);
	virtual ~AscentScriptCreatureAI();

	//Movement
	bool					GetCanMove();
	void					SetCanMove(bool pCanMove);
	void					MoveTo(AscentScriptCreatureAI* pCreature, RangeStatusPair pRangeStatus = make_pair( RangeStatus_TooFar, 0.0f ) );
	...
	//Environment
	float					GetRange(AscentScriptCreatureAI* pCreature);
	...
	AscentScriptCreatureAI*	GetNearestCreature(uint32 pCreatureId=0);
	AscentScriptCreatureAI*	SpawnCreature(uint32 pCreatureId, bool pForceSameFaction=false);
	AscentScriptCreatureAI*	SpawnCreature(uint32 pCreatureId, float pX, float pY, float pZ, float pO=0, bool pForceSameFaction=false);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//Class AscentScriptBossAI
class AscentScriptBossAI : public AscentScriptCreatureAI
{
public:
	AscentScriptBossAI(Creature *pCreature);
	virtual ~AscentScriptBossAI();
