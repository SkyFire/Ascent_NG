...
class BroggokAI : public AscentScriptCreatureAI
{
public:
	ADD_CREATURE_FACTORY_FUNCTION(BroggokAI);
	BroggokAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class TheMakerAI : public AscentScriptCreatureAI
{
public:
	ADD_CREATURE_FACTORY_FUNCTION(TheMakerAI);
	TheMakerAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
