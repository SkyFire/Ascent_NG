...
class DevouringEctoplasmAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(DevouringEctoplasmAI, AscentScriptCreatureAI);		
    DevouringEctoplasmAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
    {
...
class DruidFangAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(DruidFangAI, AscentScriptCreatureAI);	
    DruidFangAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
    {
		// Serpent Form
...
class LadyAnacondraAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(LadyAnacondraAI, AscentScriptCreatureAI);	
    LadyAnacondraAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
    {
...
class LordCobrahnAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(LordCobrahnAI, AscentScriptCreatureAI);
    LordCobrahnAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
    {
...
class LordPythasAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(LordPythasAI, AscentScriptCreatureAI);
    LordPythasAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
    {
...
class LordSerpentisAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(LordSerpentisAI, AscentScriptCreatureAI);
    LordSerpentisAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
    {
...
class VerdanEverlivingAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(VerdanEverlivingAI, AscentScriptCreatureAI);	
    VerdanEverlivingAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
    {
		// Grasping Vines
...
#define CN_SKUM						3674
class SkumAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(SkumAI, AscentScriptCreatureAI);
    SkumAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
    {
		// Chained Bolt
...
class MutanusAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(MutanusAI, AscentScriptCreatureAI);		
    MutanusAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
    {
		// Thundercrack
...
class DofNaralexAI : public AscentScriptBossAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(DofNaralexAI, AscentScriptBossAI);
    DofNaralexAI(Creature* pCreature) : AscentScriptBossAI(pCreature)
    {
		// --- Initialization ---
		for (int i = 1; i < 39; i++)
	...
	void AIUpdate()
	{
		...
		{
			AscentScriptCreatureAI* Naralex = GetNearestCreature(3679);
	...
	void Moccasin()
	{
		AscentScriptCreatureAI* Moccasin = NULL;
	...
	void Ectoplasm()
	{
		AscentScriptCreatureAI* Ectoplasm = NULL;
	...
	int32 SpawnTimer;
	SpellDesc* Awakening;
	AscentScriptCreatureAI* Mutanus;
};
// Deviate Moccasin
class DeviateMoccasinAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(DeviateMoccasinAI, AscentScriptCreatureAI);
	DeviateMoccasinAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
	}
};

// Nightmare Ectoplasm
class EctoplasmAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(EctoplasmAI, AscentScriptCreatureAI);
	EctoplasmAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
	}
};

// Naralex State
class Naralex : public AscentScriptCreatureAI
{
public:
	ASCENTSCRIPT_FACTORY_FUNCTION(Naralex, AscentScriptCreatureAI);
	Naralex(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
