...
class Glutton : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(Glutton, AscentScriptCreatureAI);
	Glutton(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
		//spells
...
class MordreshFireEye : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(MordreshFireEye, AscentScriptCreatureAI);
	MordreshFireEye(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
		//spells
