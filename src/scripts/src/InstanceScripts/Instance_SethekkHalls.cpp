...
class LakkaAI : public AscentScriptCreatureAI
{
public:
    ADD_CREATURE_FACTORY_FUNCTION(LakkaAI);
	LakkaAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
public:
    ...
    void OnDied(Unit* mKiller)
    {
		...
		{
			AscentScriptCreatureAI *pLakkaAI = static_cast<AscentScriptCreatureAI*>(mLakka->GetScript());
