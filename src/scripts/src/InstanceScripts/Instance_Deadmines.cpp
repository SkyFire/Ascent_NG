...
class NobleAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(NobleAI, AscentScriptCreatureAI);
    NobleAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature) 
	{
		// Fireball
...
class MarisaAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(MarisaAI, AscentScriptCreatureAI);
    MarisaAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature) 
	{
		// Fireball
		AddSpell(9053, Target_Current, 12, 3, 0);
	}
...
class ThistlenettleAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(ThistlenettleAI, AscentScriptCreatureAI);
    ThistlenettleAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature) 
	{
...
/* TRASH MOBS */
class DefiasEvokerAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(DefiasEvokerAI, AscentScriptCreatureAI);
    DefiasEvokerAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature) 
	{
		// Flamestrike
...
class DefiasTaskmasterAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(DefiasTaskmasterAI, AscentScriptCreatureAI);
    DefiasTaskmasterAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature) 
	{
		// Piercing Shot
...
class DefiasBlackguardAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(DefiasBlackguardAI, AscentScriptCreatureAI);
    DefiasBlackguardAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature) 
	{
		// Faded
...
class RhahkZorAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(RhahkZorAI, AscentScriptCreatureAI);
    RhahkZorAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature) 
	{
		// Rhahk'Zor Slam
	...
	*/
	...
	{
		AscentScriptCreatureAI* Patrol = NULL;
...
// Sneeds Shredder
class SneedsShredderAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(SneedsShredderAI, AscentScriptCreatureAI);
    SneedsShredderAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature) 
	{
		// Distracting Pain
...
class SneedAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(SneedAI, AscentScriptCreatureAI);
	SneedAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
		// Disarm
...
class GilnidAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(GilnidAI, AscentScriptCreatureAI);
	GilnidAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature) 
	{
		// Molten Metal
...
class MrSmiteAI : public AscentScriptBossAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION( MrSmiteAI, AscentScriptBossAI );
	MrSmiteAI( Creature* pCreature ) : AscentScriptBossAI( pCreature )
	{
...
// Greenskin
class GreenskinAI : public AscentScriptBossAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(GreenskinAI, AscentScriptBossAI);
    GreenskinAI(Creature* pCreature) : AscentScriptBossAI(pCreature)
    {
		// Poisoned Harpoon
...
// VanCleef
class VanCleefAI : public AscentScriptBossAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(VanCleefAI, AscentScriptBossAI);
    VanCleefAI(Creature* pCreature) : AscentScriptBossAI(pCreature)
    {
	...
	*/
	void AIUpdate()
	{
		...
		else if(GetHealthPercent() <= 50 && GetPhase() == 2)
		{
			...
			AscentScriptCreatureAI* Guard = NULL;
			for(int x=0; x<2; x++)
			{
...
// Cookie
class CookieAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(CookieAI, AscentScriptCreatureAI);
    CookieAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature) 
	{
		// Acid Splash
