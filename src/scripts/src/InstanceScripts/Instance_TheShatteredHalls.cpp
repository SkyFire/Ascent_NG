...
void SpellFunc_Warbringer_BurningMaul(SpellDesc* pThis, AscentScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);

class WarbringerOmroggAI : public AscentScriptCreatureAI
{
public:
	ASCENTSCRIPT_FACTORY_FUNCTION( WarbringerOmroggAI, AscentScriptCreatureAI );
	WarbringerOmroggAI( Creature* pCreature ) : AscentScriptCreatureAI( pCreature )
	{
	...
	AscentScriptCreatureAI*	mLeftHead;
	AscentScriptCreatureAI*	mRightHead;
...
class HeadAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION( HeadAI, AscentScriptCreatureAI );
	HeadAI( Creature* pCreature ) : AscentScriptCreatureAI( pCreature )
	{
		SetScale( 4.0f );
	...
	void Destroy()
	{
		...
		if ( pUnit != NULL && TO_CREATURE(pUnit)->GetScript() != NULL )
		{
			...
			if ( pAI->mLeftHead == ( AscentScriptCreatureAI* )( this ) )
				pAI->mLeftHead = NULL;
			if ( pAI->mRightHead == ( AscentScriptCreatureAI* )( this ) )
				pAI->mRightHead = NULL;
		}
	}
};
