...
class FathomGuardSharkissAI : public AscentScriptCreatureAI
{
public:
    ADD_CREATURE_FACTORY_FUNCTION(FathomGuardSharkissAI);
	FathomGuardSharkissAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
   ...
   void OnCombatStart(Unit* pTarget)
   {
	...
	void OnDied(Unit* pKiller)
	{
		...
		AscentScriptCreatureAI::OnDied(pKiller);
	}
...
class FathomGuardTidalvessAI : public AscentScriptCreatureAI
{
public:
    ADD_CREATURE_FACTORY_FUNCTION(FathomGuardTidalvessAI);
	FathomGuardTidalvessAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
		//totems
...
class FathomGuardCaribdisAI : public AscentScriptCreatureAI
{
public:
    ADD_CREATURE_FACTORY_FUNCTION(FathomGuardCaribdisAI);
	FathomGuardCaribdisAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class CoilfangAmbusherAI : public AscentScriptCreatureAI
{
public:
    ADD_CREATURE_FACTORY_FUNCTION(CoilfangAmbusherAI);
	CoilfangAmbusherAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class CoilfangFathomWitchAI : public AscentScriptCreatureAI
{
public:
    ADD_CREATURE_FACTORY_FUNCTION(CoilfangFathomWitchAI);
	CoilfangFathomWitchAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class CoilfangGuardianAI : public AscentScriptCreatureAI
{
public:
    ADD_CREATURE_FACTORY_FUNCTION(CoilfangGuardianAI);
	CoilfangGuardianAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class CoilfangPriestessAI : public AscentScriptCreatureAI
{
public:
    ADD_CREATURE_FACTORY_FUNCTION(CoilfangPriestessAI);
	CoilfangPriestessAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class UnderbogColossusAI : public AscentScriptCreatureAI
{
public:
    ADD_CREATURE_FACTORY_FUNCTION(UnderbogColossusAI);
	UnderbogColossusAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class TidewalkerWarriorAI : public AscentScriptCreatureAI
{
public:
    ADD_CREATURE_FACTORY_FUNCTION(TidewalkerWarriorAI);
	TidewalkerWarriorAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class CoilfangSerpentguardAI : public AscentScriptCreatureAI
{
public:
    ADD_CREATURE_FACTORY_FUNCTION(CoilfangSerpentguardAI);
	CoilfangSerpentguardAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class CoilfangShattererAI : public AscentScriptCreatureAI
{
public:
    ADD_CREATURE_FACTORY_FUNCTION(CoilfangShattererAI);
	CoilfangShattererAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class CoilfangStriderAI : public AscentScriptCreatureAI
{
public:
    ADD_CREATURE_FACTORY_FUNCTION(CoilfangStriderAI);
	CoilfangStriderAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
