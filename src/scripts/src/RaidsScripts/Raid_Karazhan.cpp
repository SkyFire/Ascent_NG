...
class AttumenTheHuntsmanAI : public AscentScriptBossAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(AttumenTheHuntsmanAI, AscentScriptBossAI);
	AttumenTheHuntsmanAI(Creature* pCreature) : AscentScriptBossAI(pCreature)
	{
		mMidnight = NULL;
	...
	{
		mMidnight = (AscentScriptBossAI*)GetNearestCreature(CN_MIDNIGHT);
	...
	AscentScriptBossAI* mMidnight;
};

class MidnightAI : public AscentScriptBossAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(MidnightAI, AscentScriptBossAI);
	MidnightAI(Creature* pCreature) : AscentScriptBossAI(pCreature)
	{
		mAttumen = NULL;
	}
	...
	void AIUpdate()
	{
		if( GetPhase() == 1 )
		{
			if( !mAttumen && GetHealthPercent() <= 95 && !IsCasting() )
			{
				...
				mAttumen = (AscentScriptBossAI*)SpawnCreature(CN_ATTUMEN);
			}
...
class MoroesAI : public AscentScriptBossAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(MoroesAI, AscentScriptBossAI);
	MoroesAI(Creature* pCreature) : AscentScriptBossAI(pCreature)
	{
		//Initialize timers
...
class MaidenOfVirtueAI : public AscentScriptBossAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(MaidenOfVirtueAI, AscentScriptBossAI);
	MaidenOfVirtueAI(Creature* pCreature) : AscentScriptBossAI(pCreature)
	{
		//Spells
...
class AstralFlareAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(AstralFlareAI, AscentScriptCreatureAI);
	AstralFlareAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class NetherInfernalAI : public AscentScriptBossAI
{
public:
	ASCENTSCRIPT_FACTORY_FUNCTION(NetherInfernalAI, AscentScriptBossAI);
	NetherInfernalAI(Creature* pCreature) : AscentScriptBossAI(pCreature){};
