...
class AstromancerAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(AstromancerAI, AscentScriptCreatureAI);
	AstromancerAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
		//spells
...
class VoidReaverAI : public AscentScriptBossAI
{
public:
	ASCENTSCRIPT_FACTORY_FUNCTION( VoidReaverAI, AscentScriptBossAI );
    VoidReaverAI( Creature* pCreature ) : AscentScriptBossAI( pCreature )
    {
...
void SpellFunc_Solarian_Disappear(SpellDesc* pThis, AscentScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);
void SpellFunc_Solarian_Reappear(SpellDesc* pThis, AscentScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);

class HighAstromancerSolarianAI : public AscentScriptBossAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(HighAstromancerSolarianAI, AscentScriptBossAI);
	HighAstromancerSolarianAI(Creature* pCreature) : AscentScriptBossAI(pCreature)
	{
		//Initialize timers
...
class SolariumAgentAI : public AscentScriptCreatureAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(SolariumAgentAI, AscentScriptCreatureAI);
    SolariumAgentAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
    {
...
class SolariumPriestAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(SolariumPriestAI, AscentScriptCreatureAI);
	SolariumPriestAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class SolariumSpotLight : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(SolariumSpotLight, AscentScriptCreatureAI);
	SolariumSpotLight(Creature* pCreature) : AscentScriptCreatureAI(pCreature){ SetCanEnterCombat(false); }
};
...
class DarkenerAI : public AscentScriptCreatureAI
{
public:
	ASCENTSCRIPT_FACTORY_FUNCTION(DarkenerAI, AscentScriptCreatureAI)
	DarkenerAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class SanguinarAI : public AscentScriptCreatureAI
{
public:
	ASCENTSCRIPT_FACTORY_FUNCTION(SanguinarAI, AscentScriptCreatureAI)
	SanguinarAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class CapernianAI : public AscentScriptCreatureAI
{
public:
	ASCENTSCRIPT_FACTORY_FUNCTION(CapernianAI, AscentScriptCreatureAI);
	CapernianAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class TelonicusAI : public AscentScriptCreatureAI
{
public:
	ASCENTSCRIPT_FACTORY_FUNCTION(TelonicusAI, AscentScriptCreatureAI);
	TelonicusAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class FlameStrikeAI : public AscentScriptCreatureAI
{
public:
	ASCENTSCRIPT_FACTORY_FUNCTION(FlameStrikeAI, AscentScriptCreatureAI);
	FlameStrikeAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class PhoenixAI : public AscentScriptCreatureAI
{
public:
	ASCENTSCRIPT_FACTORY_FUNCTION(PhoenixAI, AscentScriptCreatureAI);
	PhoenixAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class PhoenixEggAI : public AscentScriptCreatureAI
{
public:
	ASCENTSCRIPT_FACTORY_FUNCTION(PhoenixEggAI, AscentScriptCreatureAI);
	PhoenixEggAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class WeaponsAI : public AscentScriptCreatureAI
{
public:
	ASCENTSCRIPT_FACTORY_FUNCTION(WeaponsAI, AscentScriptCreatureAI);
	WeaponsAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
void SpellFunc_KaelThasArcaneDisruption(SpellDesc* pThis, AscentScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);
void SpellFunc_KaelThasFlameStrike(SpellDesc* pThis, AscentScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);

class KaelThasAI : public AscentScriptBossAI
{
public:
	ASCENTSCRIPT_FACTORY_FUNCTION(KaelThasAI, AscentScriptBossAI);
	KaelThasAI(Creature* pCreature) : AscentScriptBossAI(pCreature)
	{
		for (int i = 1; i < 4; ++i)
		{
		...
		if (GetPhase() == 5)
		{
			...
			else if (IsTimerFinished(mEventTimer))
			{
				for (int i = 0; i < 4; ++i)
				{
					...
					AscentScriptCreatureAI *pAI = SpawnCreature(mAdvCoords[i].mAddition, mAdvCoords[i].mX, mAdvCoords[i].mY, mAdvCoords[i].mZ, false);
					if (pAI != NULL)
					{
					...
					if (pCreature != NULL)
					{
						...
						{
							static_cast<AscentScriptCreatureAI*>(pCreature->GetScript())->AggroNearestUnit(200);
						}
					}
				}
