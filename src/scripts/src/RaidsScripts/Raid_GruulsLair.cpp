...
void SpellFunc_LairBrute_Charge(SpellDesc* pThis, AscentScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);

class LairBruteAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(LairBruteAI, AscentScriptCreatureAI);
	LairBruteAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class GronnPriestAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(GronnPriestAI, AscentScriptCreatureAI);
	GronnPriestAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
void SpellFunc_Maulgar_Enrage(SpellDesc* pThis, AscentScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);
// 4th unit sometimes cannot be found - blame cell system
uint32 Adds[4] = { 18832, 18834, 18836, 18835 };

class HighKingMaulgarAI : public AscentScriptBossAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(HighKingMaulgarAI, AscentScriptBossAI);
	HighKingMaulgarAI(Creature* pCreature) : AscentScriptBossAI(pCreature)
	{
...
class KigglerTheCrazedAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(KigglerTheCrazedAI, AscentScriptCreatureAI);
	KigglerTheCrazedAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class BlindeyeTheSeerAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(BlindeyeTheSeerAI, AscentScriptCreatureAI);
	BlindeyeTheSeerAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class OlmTheSummonerAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(OlmTheSummonerAI, AscentScriptCreatureAI);
	OlmTheSummonerAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class WildFelStalkerAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(WildFelStalkerAI, AscentScriptCreatureAI);
	WildFelStalkerAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class KroshFirehandAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(KroshFirehandAI, AscentScriptCreatureAI);
	KroshFirehandAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
		//spells
...
void SpellFunc_Gruul_GroundSlam(SpellDesc* pThis, AscentScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);
void SpellFunc_Gruul_Stoned(SpellDesc* pThis, AscentScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);
void SpellFunc_Gruul_Shatter(SpellDesc* pThis, AscentScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);

class GruulTheDragonkillerAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(GruulTheDragonkillerAI, AscentScriptCreatureAI);
	GruulTheDragonkillerAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
