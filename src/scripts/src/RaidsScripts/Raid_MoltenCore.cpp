...
class MoltenGiantAI : public AscentScriptCreatureAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(MoltenGiantAI, AscentScriptCreatureAI);
    MoltenGiantAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
    {
...
class MoltenDestroyerAI : public AscentScriptCreatureAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(MoltenDestroyerAI, AscentScriptCreatureAI);
    MoltenDestroyerAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
    {
...
class FirelordAI : public AscentScriptCreatureAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(FirelordAI, AscentScriptCreatureAI);
    FirelordAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
    {
...
class LavaAnnihilatorAI : public AscentScriptCreatureAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(LavaAnnihilatorAI, AscentScriptCreatureAI);
...
class AncientCoreHoundAI : public AscentScriptCreatureAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(AncientCoreHoundAI, AscentScriptCreatureAI);
    AncientCoreHoundAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
    {
...
class LavaSurgerAI : public AscentScriptCreatureAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(LavaSurgerAI, AscentScriptCreatureAI);
    LavaSurgerAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
    {
...
class FlameImpAI : public AscentScriptCreatureAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(FlameImpAI, AscentScriptCreatureAI);
    FlameImpAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
    {
...
class CoreHoundAI : public AscentScriptCreatureAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(CoreHoundAI, AscentScriptCreatureAI);
    CoreHoundAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
    {
...
class LavaReaverAI : public AscentScriptCreatureAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(LavaReaverAI, AscentScriptCreatureAI);
    LavaReaverAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
    {
...
class LavaElementalAI : public AscentScriptCreatureAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(LavaElementalAI, AscentScriptCreatureAI);
    LavaElementalAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
    {
...
class FlameguardAI : public AscentScriptCreatureAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(FlameguardAI, AscentScriptCreatureAI);
    FlameguardAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
    {
...
class FirewalkerAI : public AscentScriptCreatureAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(FirewalkerAI, AscentScriptCreatureAI);
    FirewalkerAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
    {
...
class LucifronAI : public AscentScriptBossAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(LucifronAI, AscentScriptBossAI);
	LucifronAI(Creature* pCreature) : AscentScriptBossAI(pCreature)
	{
...
class FlamewakerProtectorAI : public AscentScriptCreatureAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(FlamewakerProtectorAI, AscentScriptCreatureAI);
	FlamewakerProtectorAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class MagmadarAI : public AscentScriptBossAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(MagmadarAI, AscentScriptBossAI);
	MagmadarAI(Creature* pCreature) : AscentScriptBossAI(pCreature)
	{
...
class GehennasAI : public AscentScriptBossAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(GehennasAI, AscentScriptBossAI);
	GehennasAI(Creature* pCreature) : AscentScriptBossAI(pCreature)
	{
...
class FlamewakerAI : public AscentScriptCreatureAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(FlamewakerAI, AscentScriptCreatureAI);
	FlamewakerAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class GarrAI : public AscentScriptBossAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(GarrAI, AscentScriptBossAI);
	GarrAI(Creature* pCreature) : AscentScriptBossAI(pCreature)
	{
...
class FireswornAI : public AscentScriptCreatureAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(FireswornAI, AscentScriptCreatureAI);
	FireswornAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
		mGarr = NULL;
...
class BaronGeddonAI : public AscentScriptBossAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(BaronGeddonAI, AscentScriptBossAI);
	BaronGeddonAI(Creature* pCreature) : AscentScriptBossAI(pCreature)
	{
...
class ShazzrahAI : public AscentScriptBossAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(ShazzrahAI, AscentScriptBossAI);
	ShazzrahAI(Creature* pCreature) : AscentScriptBossAI(pCreature)
	{
...
class GolemaggAI : public AscentScriptBossAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(GolemaggAI, AscentScriptBossAI);
	GolemaggAI(Creature* pCreature) : AscentScriptBossAI(pCreature)
	{
