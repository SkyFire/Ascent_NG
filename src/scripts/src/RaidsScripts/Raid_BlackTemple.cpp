...
class BlackTempleScript : public AscentInstanceScript
{
public:
	ASCENTSCRIPT_INSTANCE_FACTORY_FUNCTION( BlackTempleScript, AscentInstanceScript );
	BlackTempleScript( MapMgr* pMapMgr ) : AscentInstanceScript( pMapMgr )
	{
...
class DragonTurtleAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(DragonTurtleAI, AscentScriptCreatureAI);
	DragonTurtleAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class LeviathanAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(LeviathanAI, AscentScriptCreatureAI);
	LeviathanAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class MutantWarHoundAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(MutantWarHoundAI, AscentScriptCreatureAI);
	MutantWarHoundAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature) {}
...
void SpellFunc_Charge(SpellDesc* pThis, AscentScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);

class ShadowmoonRidingHoundAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(ShadowmoonRidingHoundAI, AscentScriptCreatureAI);
	ShadowmoonRidingHoundAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class SisterOfPleasureAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(SisterOfPleasureAI, AscentScriptCreatureAI);
	SisterOfPleasureAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class SisterOfPainAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(SisterOfPainAI, AscentScriptCreatureAI);
	SisterOfPainAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class PriestessOfDementiaAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(PriestessOfDementiaAI, AscentScriptCreatureAI);
	PriestessOfDementiaAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class PriestessOfDelightAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(PriestessOfDelightAI, AscentScriptCreatureAI);
	PriestessOfDelightAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class IllidariNightlordAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(IllidariNightlordAI, AscentScriptCreatureAI);
	IllidariNightlordAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
void SpellFunc_RapidShot(SpellDesc * pThis, AscentScriptCreatureAI *pCreatureAI, Unit* pTarget, TargetType pType);

class IllidariHeartseekerAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(IllidariHeartseekerAI, AscentScriptCreatureAI);
	IllidariHeartseekerAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class IllidariFearbringerAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(IllidariFearbringerAI, AscentScriptCreatureAI);
	IllidariFearbringerAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class IllidariDefilerAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(IllidariDefilerAI, AscentScriptCreatureAI);
	IllidariDefilerAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class IllidariCenturionAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(IllidariCenturionAI, AscentScriptCreatureAI);
	IllidariCenturionAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
void SpellFunc_Gouge(SpellDesc* pThis, AscentScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);

class IllidariBoneslicerAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(IllidariBoneslicerAI, AscentScriptCreatureAI);
	IllidariBoneslicerAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class AshtongueBattlelordAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(AshtongueBattlelordAI, AscentScriptCreatureAI);
	AshtongueBattlelordAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class AshtongueDefenderAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(AshtongueDefenderAI, AscentScriptCreatureAI);
	AshtongueDefenderAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class AshtongueElementalistAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(AshtongueElementalistAI, AscentScriptCreatureAI);
	AshtongueElementalistAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class AshtongueMysticAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(AshtongueMysticAI, AscentScriptCreatureAI);
	AshtongueMysticAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class AshtonguePrimalistAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(AshtonguePrimalistAI, AscentScriptCreatureAI);
	AshtonguePrimalistAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class AshtongueRogueAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(AshtongueRogueAI, AscentScriptCreatureAI);
	AshtongueRogueAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class AshtongueSpiritbinderAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(AshtongueSpiritbinderAI, AscentScriptCreatureAI);
	AshtongueSpiritbinderAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class AshtongueStalkerAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(AshtongueStalkerAI, AscentScriptCreatureAI);
	AshtongueStalkerAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class AshtongueStormcallerAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(AshtongueStormcallerAI, AscentScriptCreatureAI);
	AshtongueStormcallerAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class BonechewerBehemothAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(BonechewerBehemothAI, AscentScriptCreatureAI);
	BonechewerBehemothAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class BonechewerBladeFuryAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(BonechewerBladeFuryAI, AscentScriptCreatureAI);
	BonechewerBladeFuryAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class BonechewerBloodProphetAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(BonechewerBloodProphetAI, AscentScriptCreatureAI);
	BonechewerBloodProphetAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class BonechewerBrawlerAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(BonechewerBrawlerAI, AscentScriptCreatureAI);
	BonechewerBrawlerAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class BonechewerCombatantAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(BonechewerCombatantAI, AscentScriptCreatureAI);
	BonechewerCombatantAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class BonechewerShieldDiscipleAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(BonechewerShieldDiscipleAI, AscentScriptCreatureAI);
	BonechewerShieldDiscipleAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class BonechewerSpectatorAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(BonechewerSpectatorAI, AscentScriptCreatureAI);
	BonechewerSpectatorAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class BonechewerTaskmasterAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(BonechewerTaskmasterAI, AscentScriptCreatureAI);
	BonechewerTaskmasterAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class BonechewerWorkerAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(BonechewerWorkerAI, AscentScriptCreatureAI);
	BonechewerWorkerAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class CharmingCourtesanAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(CharmingCourtesanAI, AscentScriptCreatureAI);
	CharmingCourtesanAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class CoilskarGeneralAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(CoilskarGeneralAI, AscentScriptCreatureAI);
	CoilskarGeneralAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class CoilskarHarpoonerAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(CoilskarHarpoonerAI, AscentScriptCreatureAI);
	CoilskarHarpoonerAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class CoilskarSeacallerAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(CoilskarSeacallerAI, AscentScriptCreatureAI);
	CoilskarSeacallerAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class CoilskarSoothsayerAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(CoilskarSoothsayerAI, AscentScriptCreatureAI);
	CoilskarSoothsayerAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class CoilskarWranglerAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(CoilskarWranglerAI, AscentScriptCreatureAI);
	CoilskarWranglerAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class DragonmawSkyStalkerAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(DragonmawSkyStalkerAI, AscentScriptCreatureAI);
	DragonmawSkyStalkerAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class DragonmawWindReaverAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(DragonmawWindReaverAI, AscentScriptCreatureAI);
	DragonmawWindReaverAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class DragonmawWyrmcallerAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(DragonmawWyrmcallerAI, AscentScriptCreatureAI);
	DragonmawWyrmcallerAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class EnslavedServantAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(EnslavedServantAI, AscentScriptCreatureAI);
	EnslavedServantAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class HandOfGorefiendAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(HandOfGorefiendAI, AscentScriptCreatureAI);
	HandOfGorefiendAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class IllidariArchonAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(IllidariArchonAI, AscentScriptCreatureAI);
	IllidariArchonAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class IllidariAssassinAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(IllidariAssassinAI, AscentScriptCreatureAI);
	IllidariAssassinAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class IllidariBattlemageAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(IllidariBattlemageAI, AscentScriptCreatureAI);
	IllidariBattlemageAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
		switch (RandomUInt(1))
		{
		case 0:
...
class IllidariBloodLordAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(IllidariBloodLordAI, AscentScriptCreatureAI);
	IllidariBloodLordAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
void SpellFunc_Whirlwind(SpellDesc *pThis, AscentScriptCreatureAI *pCreatureAI, Unit* pTarget, TargetType pType);

class ImageOfDementiaAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(ImageOfDementiaAI, AscentScriptCreatureAI);
	ImageOfDementiaAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class ShadowmoonBloodMageAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(ShadowmoonBloodMageAI, AscentScriptCreatureAI);
	ShadowmoonBloodMageAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class ShadowmoonChampionAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(ShadowmoonChampionAI, AscentScriptCreatureAI);
	ShadowmoonChampionAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
void SpellFunc_RaiseDead(SpellDesc *pThis, AscentScriptCreatureAI *pCreatureAI, Unit* pTarget, TargetType pType);

class ShadowmoonDeathshaperAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(ShadowmoonDeathshaperAI, AscentScriptCreatureAI);
	ShadowmoonDeathshaperAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
void SpellFunc_RaiseDead(SpellDesc *pThis, AscentScriptCreatureAI *pCreatureAI, Unit* pTarget, TargetType pType)
{
	...
	if (pDeathshaper != NULL)
	{
		...
		AscentScriptCreatureAI *pAI = pDeathshaper->SpawnCreature(23371, pTarget->GetPositionX(), pTarget->GetPositionY(), pTarget->GetPositionZ(), pTarget->GetOrientation());
		if (pAI != NULL)
		{
...
class ShadowmoonFallenAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(ShadowmoonFallenAI, AscentScriptCreatureAI);
	ShadowmoonFallenAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class ShadowmoonHoundmasterAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(ShadowmoonHoundmasterAI, AscentScriptCreatureAI);
	ShadowmoonHoundmasterAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class ShadowmoonReaverAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(ShadowmoonReaverAI, AscentScriptCreatureAI);
	ShadowmoonReaverAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class ShadowmoonSoldierAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(ShadowmoonSoldierAI, AscentScriptCreatureAI);
	ShadowmoonSoldierAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
void SpellFunc_DefensiveStance(SpellDesc *pThis, AscentScriptCreatureAI *pCreatureAI, Unit* pTarget, TargetType pType);
void SpellFunc_BerserkerStance(SpellDesc *pThis, AscentScriptCreatureAI *pCreatureAI, Unit* pTarget, TargetType pType);

class ShadowmoonWeaponMasterAI : public AscentScriptBossAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(ShadowmoonWeaponMasterAI, AscentScriptBossAI);
	ShadowmoonWeaponMasterAI(Creature* pCreature) : AscentScriptBossAI(pCreature)
	{
...
class SpellboundAttendantAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(SpellboundAttendantAI, AscentScriptCreatureAI);
	SpellboundAttendantAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class TempleConcubineAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(TempleConcubineAI, AscentScriptCreatureAI);
	TempleConcubineAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
void SpellFunc_StormBlink(SpellDesc* pThis, AscentScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);

class StormFuryAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(StormFuryAI, AscentScriptCreatureAI);
	StormFuryAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class AqueousSurgerAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(AqueousSurgerAI, AscentScriptCreatureAI);
	AqueousSurgerAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class AqueousSpawnAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(AqueousSpawnAI, AscentScriptCreatureAI);
	AqueousSpawnAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
void SpellFunc_SpawnAqueousSpawn(SpellDesc* pThis, AscentScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);

class AqueousLordAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(AqueousLordAI, AscentScriptCreatureAI);
	AqueousLordAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
void SpellFunc_SpawnAqueousSpawn(SpellDesc* pThis, AscentScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType)
{
	...
	{
		AscentScriptCreatureAI *pSpawnAI = pAqueousLordAI->SpawnCreature(CN_AQUEOUS_SPAWN);
		if (pSpawnAI != NULL)
		{
...
class PromenadeSentinelAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(PromenadeSentinelAI, AscentScriptCreatureAI);
	PromenadeSentinelAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class AngeredSoulFragmentAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(AngeredSoulFragmentAI, AscentScriptCreatureAI);
	AngeredSoulFragmentAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class AshtongueFeralSpiritAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(AshtongueFeralSpiritAI, AscentScriptCreatureAI);
	AshtongueFeralSpiritAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
	}
};
...
class EnslavedSoulAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(EnslavedSoulAI, AscentScriptCreatureAI);
	EnslavedSoulAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature) {}
...
class HungeringSoulFragmentAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(HungeringSoulFragmentAI, AscentScriptCreatureAI);
	HungeringSoulFragmentAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class ShadowyConstructAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(ShadowyConstructAI, AscentScriptCreatureAI);
	ShadowyConstructAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class SufferingSoulFragmentAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(SufferingSoulFragmentAI, AscentScriptCreatureAI);
	SufferingSoulFragmentAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class VangefulSpiritAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(VangefulSpiritAI, AscentScriptCreatureAI);
	VangefulSpiritAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class WrathboneFlayerAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION(WrathboneFlayerAI, AscentScriptCreatureAI);
	WrathboneFlayerAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
...
class EssenceOfSufferingAI : public AscentScriptCreatureAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(EssenceOfSufferingAI, AscentScriptCreatureAI);
    EssenceOfSufferingAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
    {
	...
	void AIUpdate()
	{
		...
		if ( GetHealthPercent() <= 1)
		{
			...
			AscentScriptCreatureAI* mRoS = GetNearestCreature(22856);
...
class EssenceOfDesireAI : public AscentScriptCreatureAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(EssenceOfDesireAI, AscentScriptCreatureAI);
    EssenceOfDesireAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
    {
...
class EssenceOfAngerAI : public AscentScriptCreatureAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(EssenceOfAngerAI, AscentScriptCreatureAI);
    EssenceOfAngerAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
    {
...
class ReliquaryOfSoulsAI : public AscentScriptCreatureAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(ReliquaryOfSoulsAI, AscentScriptCreatureAI);
    ReliquaryOfSoulsAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
    {
			...
			case 5:
				{
					...
					if ( IsTimerFinished(mEnslavedSoulTimer) && !SpawnedEnsalvedSoul )
					{
						...
						AscentScriptCreatureAI* pSpawnedEnsalvedSoul;
						for( int i=0; i<10; i++ )
						{
	...
	AscentScriptCreatureAI*	mEoS;
	AscentScriptCreatureAI*	mEoD;
	AscentScriptCreatureAI*	mEoA;
...
class GathiosAI : public AscentScriptCreatureAI
{
public:
    ASCENTSCRIPT_FACTORY_FUNCTION(GathiosAI, AscentScriptCreatureAI );
    GathiosAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
    {
...
class VerasAI : public AscentScriptCreatureAI
{
public:
    ASCENTSCRIPT_FACTORY_FUNCTION( VerasAI, AscentScriptCreatureAI );
    VerasAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
    {
...
class ZerevorAI : public AscentScriptCreatureAI
{
public:
    ASCENTSCRIPT_FACTORY_FUNCTION( ZerevorAI, AscentScriptCreatureAI );
    ZerevorAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
    {
...
class MalandeAI : public AscentScriptCreatureAI
{
public:
    ASCENTSCRIPT_FACTORY_FUNCTION( MalandeAI, AscentScriptCreatureAI );
    MalandeAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
    {
...
class UnselectableTriggerAI : public AscentScriptCreatureAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(UnselectableTriggerAI, AscentScriptCreatureAI);
    UnselectableTriggerAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
    {
...
class GenericTriggerAI : public AscentScriptCreatureAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(GenericTriggerAI, AscentScriptCreatureAI);
    GenericTriggerAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
    {
		SetCanMove(false);
...
class EyeBeamTriggerAI : public AscentScriptCreatureAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(EyeBeamTriggerAI, AscentScriptCreatureAI);
    EyeBeamTriggerAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
    {
		_unit->SetUInt64Value(UNIT_FIELD_FLAGS, UNIT_FLAG_NOT_ATTACKABLE_2);
...
class ShadowDemonAI : public AscentScriptCreatureAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(ShadowDemonAI, AscentScriptCreatureAI);
    ShadowDemonAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
    {
...
void SpellFunc_Parasitic(SpellDesc* pThis, AscentScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);

class ParasiticShadowfiendAI : public AscentScriptCreatureAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(ParasiticShadowfiendAI, AscentScriptCreatureAI);
    ParasiticShadowfiendAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
    {
...
public:
    void GossipHello(Object* pObject, Player* pPlayer, bool AutoSend)
    {
		...
		AscentScriptCreatureAI *pAI = static_cast<AscentScriptCreatureAI*>(pAIOwner->GetScript());
        GossipMenu *Menu;
...
class AkamaAI : public AscentScriptBossAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(AkamaAI, AscentScriptBossAI);
	AkamaAI(Creature* pCreature) : AscentScriptBossAI(pCreature)
    {
	...
	void IllidanDialogEvent()
	{
		if (mIllidanAI == NULL)
		{
			...
			{
				mIllidanAI = (AscentScriptCreatureAI*)(pIllidan->GetScript());
			}
		}
	...
	// AIs
	AscentScriptCreatureAI*	mIllidanAI;
	AscentScriptCreatureAI*	mUdaloAI;
	AscentScriptCreatureAI*	mOlumAI;
...
class MaievAI : public AscentScriptBossAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(MaievAI, AscentScriptBossAI);
	MaievAI(Creature* pCreature) : AscentScriptBossAI(pCreature)
    {
	...
	void DeathScene()
	{
		...
		if ((mIllidanAI != NULL && mScenePart <= 6) || mScenePart > 6)
		{
			...
			case 6:{
				...
				if (pAkama != NULL)
				{
					AkamaAI *pAkamaAI = (AkamaAI*)(static_cast<AscentScriptCreatureAI*>(pAkama->GetScript()));
...
void SpellFunc_Illidan_Parasitic(SpellDesc *pThis, AscentScriptCreatureAI *pCreatureAI, Unit* pTarget, TargetType pType);

class IllidanStormrageAI : public AscentScriptBossAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(IllidanStormrageAI, AscentScriptBossAI);
	IllidanStormrageAI(Creature* pCreature) : AscentScriptBossAI(pCreature)
	{
		//Phase 1 spells
	...
	void PhaseOne()
	{
		...
		{
			AscentScriptCreatureAI *pAI = SpawnCreature(CN_FACE_TRIGGER, 677.399963f, 305.545044f, 353.192169f, false);
			if (pAI != NULL)
			{
			...
			if (mMiscEventPart != 0)
			{
				if (mMiscEventPart == 1)
				{
					...
					if (pTrigger != NULL && pTrigger->GetScript() != NULL)
					{
						...
						EyeBeamTriggerAI *pEyeBeamTriggerAI = (EyeBeamTriggerAI*)(static_cast<AscentScriptCreatureAI*>(TO_CREATURE((pTrigger))->GetScript()));
	...
	bool SpawnMaiev()	// this doesn't have collision checks! so keep in mind that Maiev can be spawned behind walls!
	{
		...
		AscentScriptCreatureAI *pMaievAI = SpawnCreature(CN_MAIEV, newposx, newposy, _unit->GetPositionZ() + 0.5f, 2.177125f);
		if (pMaievAI == NULL)
		{
	...
	void MaievScene()	// thinking about converting Maiev's functions to AscentScriptCreatureAI functions
	{
		mTimeLeft -= mAIUpdateFrequency;
		if (mTimeLeft > 0)
			return;
		...
		if (mScenePart > 3)
		{
			...
			{
				pMaievAI = (MaievAI*)(static_cast<AscentScriptCreatureAI*>(pMaiev->GetScript()));
			}
			else
			{
				UnstuckFromShadowPrison();
			...
			if (GetRangeToUnit(pTarget) <= 80.0f)
			{
				...
				if (mFlameBurstTimer <= 0)
				{
					...
					for (unordered_set<Player*>::iterator itr = _unit->GetInRangePlayerSetBegin(); itr != _unit->GetInRangePlayerSetEnd(); ++itr) 
					{
						...
						AscentScriptCreatureAI *pAI = SpawnCreature(CN_FLAME_BURST, (*itr)->GetPositionX(), (*itr)->GetPositionY(), (*itr)->GetPositionZ(), 0, true);
	...
	void Destroy()
	{
		...
		if (pAkama != NULL && pAkama->GetScript() != NULL)
		{
			...
			if (pAI != NULL)
			{
				if (pAI->mIllidanAI == (AscentScriptCreatureAI*)(this))
					pAI->mIllidanAI = NULL;
			}
		}
...
/*		GameObject* pRightGate = _unit->GetMapMgr()->GetInterface()->GetGameObjectNearestCoords(745.07f, 241.802f, 354.292f, 200000);
	...
	// Phase 2 variables
	AscentScriptCreatureAI*	mFoA1;
	AscentScriptCreatureAI*	mFoA2;
...
class CageTrapTriggerAI : public AscentScriptCreatureAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(CageTrapTriggerAI, AscentScriptCreatureAI);
    CageTrapTriggerAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
    {
		_unit->SetUInt64Value(UNIT_FIELD_FLAGS, UNIT_FLAG_NOT_SELECTABLE);
    ...
    void AIUpdate()
    {
		...
		if (pIllidan != NULL)
		{
			IllidanStormrageAI *pAI = (IllidanStormrageAI*)(static_cast<AscentScriptCreatureAI*>(TO_CREATURE(pIllidan)->GetScript()));
			...
			if (mTriggerAIList.size() == 0 && pIllidan->isAlive() && GetRangeToUnit(pIllidan) <= 5.0f && !pAI->IsCasting())
			{
				for (int i = 0; i < 8; ++i)
				{
					AscentScriptCreatureAI *pTriggerAI = SpawnCreature(CN_CAGE_TRAP_TRIGGER, _unit->GetPositionX() + PositionAdds[i][0], _unit->GetPositionY() + PositionAdds[i][1], _unit->GetPositionZ(), _unit->GetOrientation());
					if (pTriggerAI != NULL)
					{
			...
			else if (pIllidan->isAlive() && !mHasTrapped && mTriggerAIList.size() != 0)
			{
				...
				{
					AscentScriptCreatureAI *pTriggerAI1 = mTriggerAIList[i];
					AscentScriptCreatureAI *pTriggerAI2 = mTriggerAIList[mTriggerAIList.size() - i - 1];
			...
			else if (mHasTrapped || !pIllidan->isAlive())
			{
				...
				{
					AscentScriptCreatureAI *pTriggerAI = mTriggerAIList[i];
	...
	std::vector<AscentScriptCreatureAI*>	mTriggerAIList;
	bool								mIsActivated;
	bool								mHasTrapped;
};
...
class DranaeiSpiritAI : public AscentScriptCreatureAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(DranaeiSpiritAI, AscentScriptCreatureAI);
    DranaeiSpiritAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
	{
		Despawn(45000);
		SetCanEnterCombat(false);
		_unit->m_noRespawn = true;
	...
	void Destroy()
	{
		...
		if (pAkama != NULL && pAkama->GetScript() != NULL)
		{
			...
			if (pAI != NULL)
			{
				if (pAI->mUdaloAI == (AscentScriptCreatureAI*)(this))
					pAI->mUdaloAI = NULL;
				else if (pAI->mOlumAI == (AscentScriptCreatureAI*)(this))
					pAI->mOlumAI = NULL;
			}
		}
...
void SpellFunc_FlameOfAzzinothFlameBlast(SpellDesc* pThis, AscentScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);
void SpellFunc_FlameOfAzzinothCharge(SpellDesc* pThis, AscentScriptCreatureAI* pCreatureAI, Unit* pTarget, TargetType pType);

class FlameOfAzzinothAI : public AscentScriptCreatureAI
{
    ASCENTSCRIPT_FACTORY_FUNCTION(FlameOfAzzinothAI, AscentScriptCreatureAI);
    FlameOfAzzinothAI(Creature* pCreature) : AscentScriptCreatureAI(pCreature)
    {
	...
	void Destroy()
	{
		...
		if (pIllidan != NULL && pIllidan->GetScript() != NULL)
		{
			...
			if (pAI != NULL)
			{
				if (pAI->mFoA1 == (AscentScriptCreatureAI*)(this))
					pAI->mFoA1 = NULL;
				else if (pAI->mFoA2 == (AscentScriptCreatureAI*)(this))
					pAI->mFoA2 = NULL;
			}
		}
