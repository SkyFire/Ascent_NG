...
OutlandScript::OutlandScript( MapMgr* pMapMgr ) : AscentInstanceScript( pMapMgr )
{
...
DarkPortalEventTriggerAI::DarkPortalEventTriggerAI( Creature* pCreature ) : AscentScriptCreatureAI( pCreature )
{
...
bool DarkPortalEventTriggerAI::IsRegimentFull( AIContainer pVectorSet, size_t pSetSize )
{
	...
	AscentScriptCreatureAI* SetUnit = NULL;
...
void DarkPortalEventTriggerAI::PitCommanderAttackCmd()
{
	...
	AscentScriptCreatureAI* ScriptAI = NULL;
...
void DarkPortalEventTriggerAI::PitCommanderSpawn()
{
	...
	for ( uint32 i = 0; i < 10; i += WaveSize )
	{
		...
		AscentScriptCreatureAI* ScriptAI = SpawnCreature( Entry, DSPoints[ i ].mX, DSPoints[ i ].mY, DSPoints[ i ].mZ, DSPoints[ i ].mO );
		if ( ScriptAI != NULL )
		{
			// Crappy method
			switch ( Entry )
...
MelGrommHighmountainAI::MelGrommHighmountainAI( Creature* pCreature ) : AscentScriptCreatureAI( pCreature )
{
...
OrgrimmarGruntAI::OrgrimmarGruntAI( Creature* pCreature ) : AscentScriptCreatureAI( pCreature )
{
...
OrgrimmarShamanAI::OrgrimmarShamanAI( Creature* pCreature ) : AscentScriptCreatureAI( pCreature )
{
...
DarkspearAxeThrowerAI::DarkspearAxeThrowerAI( Creature* pCreature ) : AscentScriptCreatureAI( pCreature )
{
...
UndercityMageAI::UndercityMageAI( Creature* pCreature ) : AscentScriptCreatureAI( pCreature )
{
...
JustiniusTheHarbingerAI::JustiniusTheHarbingerAI( Creature* pCreature ) : AscentScriptCreatureAI( pCreature )
{
...
StormwindSoldierAI::StormwindSoldierAI( Creature* pCreature ) : AscentScriptCreatureAI( pCreature )
{
...
IronforgePaladinAI::IronforgePaladinAI( Creature* pCreature ) : AscentScriptCreatureAI( pCreature )
{
...
DarnassianArcherAI::DarnassianArcherAI( Creature* pCreature ) : AscentScriptCreatureAI( pCreature )
{
...
StormwindMageAI::StormwindMageAI( Creature* pCreature ) : AscentScriptCreatureAI( pCreature )
{
...
PitCommanderAI::PitCommanderAI( Creature* pCreature ) : AscentScriptCreatureAI( pCreature )
{
...
InfernalSiegebreakerAI::InfernalSiegebreakerAI( Creature* pCreature ) : AscentScriptCreatureAI( pCreature )
{
...
FelSoldierAI::FelSoldierAI( Creature* pCreature ) : AscentScriptCreatureAI( pCreature )
{
...
void FelSoldierAI::Destroy()
{
	if ( mTriggerAI != NULL )
	{
		AIMap::iterator Iter = mTriggerAI->mQueuedDemonSet.find( static_cast< AscentScriptCreatureAI* >( this ) );
		if ( Iter != mTriggerAI->mQueuedDemonSet.end() )
			mTriggerAI->mQueuedDemonSet.erase( Iter );

		Iter = mTriggerAI->mFightingDemonSet.find( static_cast< AscentScriptCreatureAI* >( this ) );
...
WrathMasterAI::WrathMasterAI( Creature* pCreature ) : AscentScriptCreatureAI( pCreature )
{
	SetWieldWeapon( true );
