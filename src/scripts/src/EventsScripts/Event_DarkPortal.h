...
typedef std::vector< pair< uint32, AscentScriptCreatureAI* > >	AIContainer;
typedef std::map< AscentScriptCreatureAI*, uint32 >				AIMap;
...
class OutlandScript : public AscentInstanceScript
{
public:
	ASCENTSCRIPT_INSTANCE_FACTORY_FUNCTION( OutlandScript, AscentInstanceScript );
...
class DarkPortalEventTriggerAI : public AscentScriptCreatureAI
{
public:
	ASCENTSCRIPT_FACTORY_FUNCTION( DarkPortalEventTriggerAI, AscentScriptCreatureAI );
	...
	AscentScriptCreatureAI*		mAlliance;
	AscentScriptCreatureAI*		mHorde;
...
class MelGrommHighmountainAI : public AscentScriptCreatureAI
{
public:
	ASCENTSCRIPT_FACTORY_FUNCTION( MelGrommHighmountainAI, AscentScriptCreatureAI );
...
class OrgrimmarGruntAI : public AscentScriptCreatureAI
{
public:
	ASCENTSCRIPT_FACTORY_FUNCTION( OrgrimmarGruntAI, AscentScriptCreatureAI );
...
class OrgrimmarShamanAI : public AscentScriptCreatureAI
{
public:
	ASCENTSCRIPT_FACTORY_FUNCTION( OrgrimmarShamanAI, AscentScriptCreatureAI );
...
class DarkspearAxeThrowerAI : public AscentScriptCreatureAI
{
public:
	ASCENTSCRIPT_FACTORY_FUNCTION( DarkspearAxeThrowerAI, AscentScriptCreatureAI );
...
class UndercityMageAI : public AscentScriptCreatureAI
{
public:
	ASCENTSCRIPT_FACTORY_FUNCTION(UndercityMageAI, AscentScriptCreatureAI);
...
void SpellFunc_Justinius_Consecration( SpellDesc *pThis, AscentScriptCreatureAI *pCreatureAI, Unit* pTarget, TargetType pType );

class JustiniusTheHarbingerAI : public AscentScriptCreatureAI
{
public:
	ASCENTSCRIPT_FACTORY_FUNCTION( JustiniusTheHarbingerAI, AscentScriptCreatureAI );
...
class StormwindSoldierAI : public AscentScriptCreatureAI
{
public:
	ASCENTSCRIPT_FACTORY_FUNCTION( StormwindSoldierAI, AscentScriptCreatureAI );
...
class IronforgePaladinAI : public AscentScriptCreatureAI
{
public:
	ASCENTSCRIPT_FACTORY_FUNCTION( IronforgePaladinAI, AscentScriptCreatureAI );
...
class DarnassianArcherAI : public AscentScriptCreatureAI
{
public:
	ASCENTSCRIPT_FACTORY_FUNCTION( DarnassianArcherAI, AscentScriptCreatureAI );
...
class StormwindMageAI : public AscentScriptCreatureAI
{
public:
	ASCENTSCRIPT_FACTORY_FUNCTION( StormwindMageAI, AscentScriptCreatureAI );
...
class PitCommanderAI : public AscentScriptCreatureAI
{
public:
	ASCENTSCRIPT_FACTORY_FUNCTION( PitCommanderAI, AscentScriptCreatureAI );
...
class InfernalSiegebreakerAI : public AscentScriptCreatureAI
{
public:
	ASCENTSCRIPT_FACTORY_FUNCTION( InfernalSiegebreakerAI, AscentScriptCreatureAI );
...
class FelSoldierAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION( FelSoldierAI, AscentScriptCreatureAI );
...
class WrathMasterAI : public AscentScriptCreatureAI
{
	ASCENTSCRIPT_FACTORY_FUNCTION( WrathMasterAI, AscentScriptCreatureAI );
